...
- [x] **流体动力学交互** - 画布平移支持惯性滑动，节点移动支持弹簧阻尼效果
- [x] **有机连线视觉** - 贝塞尔曲线连线，带发光发亮与微粒流动效果，极具“生命感”
- [x] **原生级 Markdown 渲染** - 完美解析标题、公式、表格、代码块，排版精美
- [x] **极简 AI 身份标识** - 移除冗余头像，以极简 Model Tag 提示当前模型
- [x] **重构消息操作 UI** - 复制、编辑、重新生成按钮智能隐藏，位置更符合操作直觉
- [x] **智能 Prompt 调优** - 优化默认系统提示词，AI 回复更加简洁精准，杜绝废话
