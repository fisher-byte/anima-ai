...
export const en: Translations = {
  ...
  canvas: {
    ...
    ongoingDecisions: 'Ongoing decisions',
    ongoingDecisionsCount: (n: number) => `${n} decision${n === 1 ? '' : 's'} to keep moving`,
    ongoingDecisionsEmpty: 'No active decisions yet',
    ongoingDecisionsHint: 'Once you adopt a recommendation, it will show up here for follow-up.',
    ongoingDecisionDue: (date: string) => `Review due · ${date}`,
  ...
  modal: {
    ...
    sessionSpaceLenny: 'Lenny space',
    sessionSpacePg: 'Paul Graham space',
    sessionSpaceZhang: 'Zhang Xiaolong space',
    sessionSpaceWang: 'Wang Huiwen space',
    sessionSpaceCustom: (name: string) => `${name} · custom space`,
    sessionSpaceCustomDefault: 'Custom space',
    sessionModeLingSi: 'LingSi decision',
    sessionModeNormal: 'Chat',
    sessionModelThinking: 'Model reasoning…',
    sessionBadgeSep: ' · ',
    lingsiEvidence: 'Decision Evidence',
    ...
    lingsiTraceWaitForCompletion: 'Wait until the answer finishes streaming before opening the trace',
    lingsiTraceView: 'Decision trace',
    lingsiMatchedUnits: 'Matched units',
    lingsiNoMatchedUnits: 'No specific decision unit matched',
    lingsiNoMatchedUnitsBody: 'This question is closer to a current-project judgment than a reusable case pattern, so the answer mainly relies on the current product state.',
    lingsiStatePack: 'Current product state',
    lingsiStatePackSummary: 'No specific case was matched. The answer mainly relies on the current sprint, roadmap, changelog, and eval baselines.',
    lingsiStatePackFallback: 'This answer references the current product state, not only explicit decision units.',
    ...
    decisionCardStatusDraft: 'Draft',
    decisionCardStatusAnswered: 'Ready to adopt',
    decisionCardStatusAdopted: 'In progress',
    decisionCardStatusRevisited: 'Reviewed',
    decisionCardStatusArchived: 'Archived',
    decisionCardNextActions: 'Next actions',
    decisionCardAdoptTitle: 'Turn this suggestion into a tracked decision',
    decisionCardAdoptBody: 'Pick a revisit time first. Anima will remember it and come back to ask what happened.',
    decisionCardAdopt: 'Adopt suggestion',
    decisionCardAdoptDays: (days: number) => `Review in ${days} day${days === 1 ? '' : 's'}`,
    decisionCardRevisitAt: (date: string) => `Next revisit: ${date}`,
    decisionCardOutcomeTitle: 'What happened next?',
    decisionCardOutcomeWorking: 'Worked',
