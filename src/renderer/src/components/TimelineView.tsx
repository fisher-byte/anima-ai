    ...
    >
      <div
        style={{
          ...
          minHeight: HEADER_H + categories.length * ROW_H + 40,
          paddingBottom: 40,
        }}
      >
        {/* 顶部日期标签行 */}
        ...
        {categories.map((cat, rowIdx) => {
          ...
          return (
            ...
            >
              {/* 分类标签 */}
              <div
                style={{ width: LABEL_W, flexShrink: 0, paddingLeft: 16 }}
              ...
              <div style={{ position: 'relative', flex: 1 }}>
                {rowNodes.map(node => {
                  const colIdx = dates.indexOf(node.date)
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs font-medium text-gray-700 line-clamp-3 leading-snug">
                        {node.title || '无标题'}
                      </p>
                    </button>
                  )
