import type { DecisionPersona, DecisionProductStatePack, DecisionSourceManifestEntry, DecisionUnit } from './types'
...
export const BUNDLED_DECISION_PRODUCT_STATE = decisionProductStateSeed as DecisionProductStatePack
